...
class PascalNLABDetectionEvaluator(DatasetEvaluator):
    """
    ...
    def __init__(self, dataset_name):
        """
        Args:
            dataset_name (str): name of the dataset, e.g., "nlab_2019_test"
        """
    ...
    def evaluate(self):
        ...
        with tempfile.TemporaryDirectory(prefix="pascal_nlab_eval_") as dirname:
        ...
        ret["bbox"].update({"AP{}".format(th): mAP[th] for th in range(50, 100, 5)})
        return ret
